    ...
    <ContentRenderer :value="data as any">
      <div v-for="item in data" :key="item">
        <div>
          ...
          <div class="grid grid-cols-2 gap-4 opacity-50 hover:opacity-100">
            <a :href="item.websiteUrl" target="_blank" class="bg-gray-200 hover:bg-gray-400 h-10 px-4 rounded flex items-center w-full mt-4">
            ...
            <a
              ...
              class="bg-gray-200 hover:bg-gray-400 h-10 px-4 rounded flex items-center w-full mt-4"
            >
