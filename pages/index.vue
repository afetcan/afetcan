...
<template>
  <WebMainContent back-on-small-screen>
    ...
    <div
      class="flex flex-col justify-center items-center w-full max-w-xl mx-auto"
    >
      <div class="mt-4 w-full">
        <div v-if="selectedCountry" class="w-full flex flex-col">
          <div class="flex justify-between items-center w-full">
            ...
            <div>
              <button
                ...
                @click="appStore.resetSelectedCountry()"
              >
                {{ $t('global.change') }}
              </button>
            </div>
          ...
          <div
            class="text-black w-full bg-gray-200 mt-4 rounded-lg h-10 flex items-center justify-center text-lg"
          >
